        <el-form ref="searchForm" class="search-form" :model="searchParams" label-position="left" size="small" label-width="120px">
            <el-row :gutter="10">
<#list table.indexes as column>
                ...
                <#elseif (isString)>
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="6">
                    <el-form-item label="${columnComment}" prop="${fieldName}StartWith">
                        <el-input v-model="searchParams.${fieldName}StartWith"></el-input>
                    </el-form-item>
                </el-col>
                <#elseif (isDate || isDateTime)>
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="6">
                    <el-form-item label="${columnComment}" prop="${fieldName}Range">
                        <el-date-picker
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="6">
                    <el-form-item class="form-action">
                        ...
                        <el-button @click="exportExcel" v-permission="'${module}:${tablePath}:export'" type="success" icon="el-icon-download">导出</el-button>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
